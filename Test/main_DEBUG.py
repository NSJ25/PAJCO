...
SERVO_CLOSED = 3276   # 1ms → 0° (barrière FERMÉE, baissée)
SERVO_OPEN = 4915     # 1.5ms → 90° (barrière OUVERTE, levée)

# Plus besoin de SERVO_NEUTRAL !

# Configuration des timeouts
CAPTEUR_TIMEOUT = 15  # Temps d'attente max pour détection (secondes)
PASSAGE_DELAY = 5     # Temps d'attente après détection (secondes)
